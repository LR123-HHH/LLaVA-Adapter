...
if __name__ == "__main__":
    ...
    parser.add_argument("--input-file", type=str, default="/root/autodl-tmp/t15_test.json")
    parser.add_argument("--output-file", type=str, default="/root/autodl-tmp/t15_test_output_baseline.json")
